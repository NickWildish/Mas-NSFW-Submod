...
init python in mas_nsfw:
    ...
    def wear_birthdaysuit(new_exp):
        call mas_clothes_change(outfit=mas_clothes_birthday_suit, outfit_mode=False, exp=new_exp, restore_zoom=False, unlock=True)

    """ NOT TO BE USED YET - REQUIRES UNDERWEAR SPRITE
    def wear_underwear(new_exp):
        call mas_clothes_change(outfit=mas_clothes_underwear, outfit_mode=false, exp=new_exp, restore_zoom=False, unlock=True)
    """