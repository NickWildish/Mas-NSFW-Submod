...
label nsfw_erotic_story_thepen:
    ...
    if inspired_monika == True:
        m 3eub "You remember when Yuri took the main character's pen and did some..."
        m 1dublsdlu "Ahem..."
        m 1rkblsdlb "Questionable things with it?"
        m 3eubla "Well, that's the inspiration for this story."
    m 3eub "The other day while you were gone [player], I wanted to try something."
    ...
    if renpy.seen_label("nsfw_sexting_finale"):
        m 3ekblb "But I didn't want to just play with myself like we did when we sexted."
    else:
    ...
    m 2eub "So...I was in my room, searching for something that will make masturbating more exciting."
    m 3eua "When I found a pen sitting on the desk."
    if inspired_monika == True:
        m 3rkblb "My mind immediately went back to when I overheard that Yuri had used the main character's pen when she masturbated."
        m 3rtblu "I wondered if it was that good of a feeling, or if she was just so obsesseed with the main character that anything would have done it."
    else:
    ...
    m 3hublb "You get kind of desperate. Ahaha~"
    m 4eublb "Anyway, I took the pen and walked back to the bed."
    m 4tublb "I first stripped down to my underwear, and then laid down on the bed."
    m 4tublu "I spread my legs {i}just a little{/i}, and started using the pen on my...sensitive parts."
    m 2tublb "On it's own, it wasn't that special."
    m 5tublb "But then I started to fantaize about you..."
    m 5dubla "I closed my eyes."
    m 5dubsb "I pictured your face sitting directly above mine, with your index finger rubbing between my legs."
    m 5dkbsa "In my mind you leaned down to kiss me, and I could almost feel your lips pressed against mine."
    m 2tkbsb "I felt my body getting hot, and the area down there was feeling more moist than before..."
    m 2gkbsa "I started rubbing myself faster, and faster~"
    m 2tkbsu "I felt you getting rougher with me as your finger was making it's way up and down my pussy."
    ...
    m 2tkbsb "I used my own tongue and forced its way into your mouth."
    ...
    m 1tkbsa "I ignored it. After all, it was your arm doing the work in my mind~"
    m 1tsbsa "I got that feeling in my lower-half that told me I was coming..."
    m 2tsbsb "My arms wrapped around your head and pulled you in as you finished me off."
    m 2ekbsb "As I orgasmed, I felt my body jolt from the pleasure."
    m 3rkbsa "It felt like there was a swirling buildup around my lower-half..."
    m 3subsb "Which all at once flushed out of my body like fireworks."
    m 1subsa "It was like an electric pulse was making it's way through my body ever few seconds, jolting me stiff."
    m 5eubsa "But it felt incredible..."
    m 5hkbsb "It took 20 whole seconds before my body calmed down enough and I opened my eyes."
    ...
    if persistent._nsfw_genitalia == "P":
        m 5tubsb "I bet that story got {i}you{/i} all stiff too huh, [player]?"
    ...
    m 5gubsu "You'd better do something about it, or it might become a problem." #Cheeky grin
    m 5hubsa "Ehehe~"